...
# -DMANUAL_ALLOCATION -DMANUAL_CONTROL
  cmdline="${cmdline} -DTIMING -DTIME_MEASURE -DPLOGGING -DMANUAL_CONTROL -DUSE_CILK_PLUS_RUNTIME -fcilkplus -DNDEBUG -ltcmalloc -L/home/rainey/Installs/gperftools/lib/"
# -DTIME_MEASURE
